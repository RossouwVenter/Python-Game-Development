...
class SpaceShip(pygame.sprite.Sprite):
	...
	def screen_constrain(self): # blocks the ship to go out of screen!
...
def main_game():
	...
	laser_group.update()	
	spaceship_group.update() # mouse movement call
	meteor_group.update()
...
pygame.time.set_timer(METEOR_EVENT,150)# triggers x times per sec in milliseconds

while True:
	for event in pygame.event.get(): # check for events/input
	...
	pygame.display.update()# draw the frame
